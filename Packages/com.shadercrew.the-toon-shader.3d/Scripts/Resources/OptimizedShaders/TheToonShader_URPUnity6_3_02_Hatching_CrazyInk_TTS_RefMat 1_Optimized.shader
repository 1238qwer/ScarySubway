Shader "TheToonShader/Optimized/URP/Unity6_3/TheToonShader_02_Hatching_CrazyInk_TTS_RefMat 1_Optimized"
{
   Properties
   {
...
[HideInInspector]_QueueOffset("_QueueOffset", Float) = 0
   ...
   SubShader
   {
	...
	HLSLINCLUDE
		...
		#define _ENABLE_TOON_SHADING 1
		#define _LIGHT_SOURCE 0
		#define _SHADING_FUNCTION 0
		#define _ENABLE_SHADOWS 1
		#define _ENABLE_CAST_SHADOWS 1
		#define _SPECULAR_BLENDING 1
		#define _RIM_BLENDING 0
		#define _SUM_LIGHTS_BEFORE_POSTERIZATION 1
		#define _SHADING_USE_LIGHT_COLORS 1
		#define _SPECULAR_USE_LIGHT_COLORS 1
		#define _ENABLE_STYLING 1
		#define _STYLING_CASTSHADOWS_SYNC_WITH_OTHER_STYLING 1
		#define _ENABLE_SHADING_STYLING 1
		#define _SHADING_STYLING_TERMINATORPOSITION 1
		#define _SHADING_STYLING_BLENDING 0
		#define _SHADING_STYLING_DRAWSPACE 0
		#define _SHADING_STYLING_UVSET 0
		#define _SHADING_STYLING_COORDINATESYSTEM 1
		#define _SHADING_STYLE 0
		#define _SHADING_STYLING_NUMBER_OF_CELLS_HATCHING 2
		#define _SHADING_STYLING_RANDOMIZER 1
		#define _SHADING_STYLING_RANDOMIZER_PERLIN_FLOORED 1
		#define _SHADING_STYLING_RANDOMIZER_WHITE 1
		#define _ENABLE_CASTSHADOWS_STYLING 1
		#define _CASTSHADOWS_STYLING_BLENDING 0
		#define _CASTSHADOWS_STYLING_DRAWSPACE 0
		#define _CASTSHADOWS_STYLING_UVSET 0
		#define _CASTSHADOWS_STYLING_COORDINATESYSTEM 1
		#define _CASTSHADOWS_STYLE 0
		#define _CASTSHADOWS_STYLING_NUMBER_OF_CELLS_HATCHING 2
		#define _CASTSHADOWS_STYLING_RANDOMIZER 1
		#define _CASTSHADOWS_STYLING_RANDOMIZER_PERLIN_FLOORED 1
		#define _CASTSHADOWS_STYLING_RANDOMIZER_WHITE 1
	ENDHLSL
